...
import { z } from "zod";
import { whatsappPersonalAssistant } from "../agents";
...
const personalAssistantWorkflow = new Workflow({
	name: "personal-assistant-workflow",
	triggerSchema: z.object({
		message: z
			.string()
			.describe("The message to send to the personal assistant"),
	}),
}).step(whatsappPersonalAssistant);
